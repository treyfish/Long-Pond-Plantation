    ...
    <section id="day">
      <div class="sticky">
        ...
        <img class="scene" data-i="5" src="assets/img/day-night.jpg" alt="The last dance in the White Barn" />
        <div class="scrim"></div>
        ...
        <div class="caption">
          ...
          <div class="labels"><span>MORNING</span><span>GETTING READY</span><span>CEREMONY</span><span>DINNER</span><span>GOLDEN HOUR</span><span>LAST DANCE</span></div>
        </div>
      </div>
    </section>
    <script>
      (function () {
        ...
        var scenes = [
          ...
          { t: '10:00 PM', title: 'Last dance in the barn',   cap: 'Glow sticks up, the barn humming late into the night.' }
        ];
        var N = scenes.length;
      ...
      <div class="max-w-site mx-auto space-y-16 mt-14">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <img class="w-full aspect-square object-cover shadow-card" src="assets/img/bride-gold-mirror.jpg" alt="Bride at the gold mirror" />
