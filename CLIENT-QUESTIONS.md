...
- **Contact form endpoint:** Form posts to a placeholder (no backend). Decide: Formspree / Vercel serverless / email service. SMS-consent checkbox included WM-style — confirm they want SMS marketing language.
